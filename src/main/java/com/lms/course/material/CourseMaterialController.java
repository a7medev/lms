...
public class CourseMaterialController {
    ...
    @GetMapping
    public List<CourseMaterial> getMaterialsForCurrentUser(@PathVariable Long courseId, Principal currentUser) {
        return courseMaterialService.getMaterialsForCurrentStudent(courseId, currentUser);
    }
